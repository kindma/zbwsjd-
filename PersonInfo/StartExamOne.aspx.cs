...
namespace EasyExam.PersonalInfo
{
	...
	/// StartExamOne 的摘要说明。
	/// </summary>
	public partial class StartExamOne : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				if (intPaperID!=0)
				{
					...
					//SqlCmdTestType=new SqlDataAdapter("select TestTypeID from PaperTestType where TestTypeID="+SqlDSTest.Tables["UserAnswer"].Rows[0]["TestTypeID"].ToString()+" and PaperID="+intPaperID+" order by PaperTestTypeID asc",SqlConn);
