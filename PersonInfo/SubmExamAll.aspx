<%@ Page language="c#" Inherits="EasyExam.PersonalInfo.SubmExamAll" CodeFile="SubmExamAll.aspx.cs" %>
...
</dl><!-- #EndLibraryItem --><%=strMessage%> <FONT face="宋体"></FONT> 
<script>
	if(top!=this) window.parent.document.body.innerHTML=document.body.innerHTML;
	</script>
</body>
</HTML>
