...
public partial class PersonInfo_SubRedoOne : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((intPaperID != 0) && (intUserScoreID != 0))
        {
            try
            {
                ...
                SqlCmdTest = new SqlDataAdapter("select a.TestMark,b.StandardAnswer from UserAnswer a,RubricInfo b,PaperTestType c where a.RubricID=b.RubricID and b.TestTypeID=c.TestTypeID and a.UserScoreID=" + intUserScoreID + " and c.PaperID=" + intPaperID + " and a.UserScore = 0 order by c.PaperTestTypeID,a.TestOrder", SqlConn);
            ...
            Response.Redirect("RedoExamOne.aspx?UserScoreID=" + intUserScoreID);
        }
    }
}