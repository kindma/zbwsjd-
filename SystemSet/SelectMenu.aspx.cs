...
//				{
//					ButInput.Attributes.Add("onclick", "javascript:alert('对不起，未注册用户不能设置角色菜单！');return false;");
//				}
...
//			{
//				this.RegisterStartupScript("newWindow","<script language='javascript'>alert('对不起，未注册用户不能设置角色菜单！')</script>");
//				return;
//			}
			//保存到数据库
			int i=0;
