<%@ Page language="c#" Inherits="EasyExam.SystemSet.ManagSubjectList" CodeFile="ManagSubjectList.aspx.cs" %>
						...
						<table style="BORDER-COLLAPSE: collapse" borderColor="#6699ff" height="500" cellSpacing="0"
							...
							<tr>
								<td style="COLOR: #990000" align="center" background="../Images/bg_dh_middle.gif" bgColor="#ffffff"
									height="24"><font style="FONT-SIZE: 16px" face="黑体" color="#ffffff">科目</font><font style="FONT-SIZE: 16px" face="黑体" color="#ffffff">设置</font></td>
							</tr>
							<tr>
								<td height="23">&nbsp;科目名称：<asp:textbox id="txtSubjectName" runat="server" Width="136px" CssClass="text"></asp:textbox>
							...
							<TR>
								<td vAlign="top" align="center"><asp:datagrid id="DataGridSubject" runat="server" Width="100%" PageSize="15" CellPadding="0" BorderWidth="1px"
										...
										<Columns>
											<asp:BoundColumn Visible="False" DataField="SubjectID" ReadOnly="True" HeaderText="SubjectID">
											...
											<asp:TemplateColumn HeaderText="知识点">
												<ItemStyle HorizontalAlign="Center"></ItemStyle>
												<ItemTemplate>
													<asp:LinkButton id="LinkButEditLore" runat="server">知识点编辑</asp:LinkButton>
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:TemplateColumn HeaderText="设置">
												...
												<ItemStyle HorizontalAlign="Center"></ItemStyle>
												<ItemTemplate>
													<asp:LinkButton id="LinkButUser" runat="server" Text="浏览帐号" CommandName="User" CausesValidation="false">浏览帐号</asp:LinkButton>
												</ItemTemplate>
											</asp:TemplateColumn>
							...
							<tr>
								<td style="HEIGHT: 23px" align="center"><FONT face="宋体"><asp:button id="ButNewMoreSubject" runat="server" CssClass="button" Text="批量添加"></asp:button>&nbsp;
										<asp:button id="ButDelete" runat="server" CssClass="button" Text="删除科目" onclick="ButDelete_Click"></asp:button></FONT></td>
							</tr>
						</table>
						<!--内容结束--></td>
				</tr>
