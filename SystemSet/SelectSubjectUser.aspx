<%@ Page language="c#" Inherits="EasyExam.SystemSet.SelectSubjectUser" CodeFile="SelectSubjectUser.aspx.cs" %>
	...
	<body leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="480" align="center" border="0">
				<tr height="25">
					<td style="WIDTH: 499px" align="center"><font style="FONT-SIZE: 16px" face="黑体" color="#0054a6">设置浏览帐号</font></td>
				</tr>
				<tr>
