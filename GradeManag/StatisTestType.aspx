<%@ Page language="c#" Inherits="EasyExam.GradeManag.StatisTestType" CodeFile="StatisTestType.aspx.cs" %>
	...
	<body leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="1" width="95%" align="center" border="0">
				...
				<tr>
					<td align="center"><FONT style="FONT-SIZE: 16px" face="黑体" color="#0054a6">【<asp:label id="labPaperName" runat="server" ForeColor="#0054a6"></asp:label>】题型统计</FONT></td>
				</tr>
				<tr>
					<td style="HEIGHT: 2px" bgColor="#0000ff" height="2"><FONT face="宋体"></FONT></td>
				</tr>
				<tr>
					<td align="center"><FONT face="宋体"><asp:datagrid id="DataGridTestType" runat="server" Width="100%" AutoGenerateColumns="False" BorderWidth="1px"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="TestTypeTitle" SortExpression="TestTypeTitle" HeaderText="题型标题"></asp:BoundColumn>
