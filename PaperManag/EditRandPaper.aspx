<%@ Page language="c#" Inherits="EasyExam.PaperManag.EditRandPaper" CodeFile="EditRandPaper.aspx.cs" %>
						...
						<table style="BORDER-COLLAPSE: collapse" borderColor="#6699ff" height="300" cellSpacing="0"
							...
							<tr>
								<td style="COLOR: #990000" align="center" background="../Images/bg_dh_middle.gif" bgColor="#ffffff"
									height="24">
									<font face="黑体" style="FONT-SIZE: 16px" color="#ffffff">修改随机组卷</font></td>
							</tr>
							<tr>
									...
									<TABLE id="Table1" style="BORDER-COLLAPSE: collapse" borderColor="#dadada" cellSpacing="0"
										...
										<TR>
											...
											<td style="HEIGHT: 17px" width="223"><asp:dropdownlist id="DDLProduceWay" runat="server" Width="80px">
													...
													<asp:ListItem Value="3">试题随机</asp:ListItem>
												</asp:dropdownlist></td>
										</TR>
										<TR>
											...
											<td style="HEIGHT: 16px" width="223"><FONT face="宋体"><asp:textbox id="txtExamTime" runat="server" CssClass="text" Width="40px" MaxLength="50"></asp:textbox>分钟</FONT></td>
										</TR>
										<TR>
										...
										<TR>
											...
											<TD style="HEIGHT: 15px" width="223"><FONT face="宋体"><asp:textbox id="txtPassMark" runat="server" CssClass="text" Width="40px" MaxLength="50"></asp:textbox></FONT></TD>
										</TR>
										<tr>
										...
										<tr>
											...
											<td width="285" colSpan="2"><FONT face="宋体"><asp:checkbox id="chkFillAutoGrade" runat="server" Text="允许填空类试题自动评卷"></asp:checkbox></FONT></td>
										</tr>
										<tr>
											<td width="265" colSpan="2"><asp:checkbox id="chkSeeResult" runat="server" Text="允许查看评卷结果"></asp:checkbox></td>
											<td width="285" colSpan="2"><FONT face="宋体"><asp:checkbox id="chkAutoSave" runat="server" Text="允许自动保存答卷"></asp:checkbox>&nbsp;间隔时间：<asp:textbox id="txtSaveTime" runat="server" CssClass="text" Width="24px" MaxLength="50">5</asp:textbox>分钟</FONT>
											</td>
										</tr>
										<TR bgColor="#ebf5fa" height="16">
										...
										<TR>
											<TD align="center" colSpan="4"><asp:button id="ButAddPolicy" runat="server" CssClass="text" Text="添加策略" onclick="ButAddPolicy_Click"></asp:button></TD>
										</TR>
										<TR>
