<%@ Page Language="c#" Inherits="EasyExam.PaperManag.AddCustomPolicy" CodeFile="AddCustomPolicy.aspx.cs" %>
	...
	<body leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="780" align="center" border="0">
				<tr>
					<td colSpan="3" height="25" align="center" rowSpan="1"><FONT face="宋体"><FONT style="FONT-SIZE: 16px" face="黑体" color="#0054a6">添加手工策略</FONT></FONT></td>
				</tr>
				<TR>
					<TD align="center" colSpan="3" height="23" rowSpan="1"><FONT face="宋体">科目名称：
							<asp:dropdownlist id="DDLSubjectName" runat="server" Width="92px" AutoPostBack="True" onselectedindexchanged="DDLSubjectName_SelectedIndexChanged">
								<asp:ListItem Value="0">--请选择--</asp:ListItem>
							</asp:dropdownlist>知识点：
							<asp:dropdownlist id="DDLLoreName" runat="server" Width="92px" AutoPostBack="True" onselectedindexchanged="DDLLoreName_SelectedIndexChanged">
								<asp:ListItem Value="0">--请选择--</asp:ListItem>
							</asp:dropdownlist>题型名称：
							<asp:dropdownlist id="DDLTestTypeName" runat="server" Width="92px" AutoPostBack="True" onselectedindexchanged="DDLTestTypeName_SelectedIndexChanged">
								<asp:ListItem Value="0">--请选择--</asp:ListItem>
							</asp:dropdownlist>
				...
				<tr>
					...
					<td width="1" style="HEIGHT: 432px"></td>
				</tr>
				<tr>
					<td colSpan="3" height="1" align="center"><asp:Button id="ButInput" runat="server" CssClass="button" Text="提 交" onclick="ButInput_Click"></asp:Button>&nbsp;
