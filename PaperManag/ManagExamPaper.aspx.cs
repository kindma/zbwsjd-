...
{
	/// <summary>
	/// ManagExamPaper 的摘要说明。
	/// </summary>
	public partial class ManagExamPaper : System.Web.UI.Page
	{
...
//					else
//					{
						ButRandPaper.Attributes.Add("onclick","javascript:jscomNewOpenBySize('NewRandPaper.aspx?PaperType=1','NewRandPaper',700,600); return false;");
						ButCustomPaper.Attributes.Add("onclick","javascript:jscomNewOpenBySize('NewCustomPaper.aspx?PaperType=1','NewCustomPaper',700,600); return false;");
//					}
					ButDelete.Attributes.Add("onclick","javascript:{if(confirm('确定要删除选择试卷吗？')==false) return false;}");
					strSql="select a.PaperID,a.PaperName,a.PaperType,case a.ProduceWay when 1 then '题序固定' when 2 then '题序随机' when 3 then '试题随机' end as ProduceWay,a.ExamTime,a.StartTime,a.EndTime,a.TestCount,a.PaperMark,a.CreateWay,b.LoginID as CreateLoginID,convert(varchar(10),a.CreateDate,120) as CreateDate from PaperInfo a LEFT OUTER JOIN UserInfo b ON a.CreateUserID=b.UserID  where a.PaperType=1 order by a.PaperID desc";
