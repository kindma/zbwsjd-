<%@ Page language="c#" Inherits="EasyExam.PaperManag.AddRandPolicy" CodeFile="AddRandPolicy.aspx.cs" %>
	...
	<body leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="500" align="center" border="0">
				<tr>
					<td align="center" colSpan="3" height="24" rowSpan="1"><FONT face="宋体"><FONT style="FONT-SIZE: 16px" face="黑体" color="#0054a6">添加随机策略</FONT></FONT></td>
				</tr>
				<TR>
					<TD align="center" colSpan="3" height="22" rowSpan="1"><FONT face="宋体">科目名称：
							<asp:dropdownlist id="DDLSubjectName" runat="server" AutoPostBack="True" Width="92px" onselectedindexchanged="DDLSubjectName_SelectedIndexChanged">
								<asp:ListItem Value="0">--请选择--</asp:ListItem>
							</asp:dropdownlist>知识点：
							<asp:dropdownlist id="DDLLoreName" runat="server" AutoPostBack="True" Width="92px" onselectedindexchanged="DDLLoreName_SelectedIndexChanged">
								<asp:ListItem Value="0">--请选择--</asp:ListItem>
							</asp:dropdownlist>题型名称：
							<asp:dropdownlist id="DDLTestTypeName" runat="server" AutoPostBack="True" Width="92px" onselectedindexchanged="DDLTestTypeName_SelectedIndexChanged">
								<asp:ListItem Value="0">--请选择--</asp:ListItem>
				...
				<tr>
					<td align="center" colSpan="3" height="1"><FONT face="宋体">
