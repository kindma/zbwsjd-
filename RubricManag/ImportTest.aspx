...
<HTML>
	...
	<body leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table height="224" cellSpacing="0" cellPadding="0" width="505" align="center" border="0">
				<tr>
					<td height="40"></td>
				</tr>
				<tr>
					<td>
						...
						<table style="BORDER-COLLAPSE: collapse" borderColor="#6699ff" height="184" cellSpacing="0"
							cellPadding="0" width="485" border="1">
							<tr>
							...
							<tr>
								<td>
									<TABLE id="Table2" height="150" cellSpacing="0" cellPadding="0" width="500" border="0"
										...
										<tr>
											<td align="center" colSpan="2" height="23">导入模板下载：<FONT face="宋体"><A href="../TempletFiles/ImportTest.xls">ImportTest.xls</A></FONT></td>
										</tr>
										<TR>
