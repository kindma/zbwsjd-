<%@ Page language="c#" Inherits="EasyExam.RubricManag.EditTest" CodeFile="EditTest.aspx.cs" %>
						...
						<table style="BORDER-COLLAPSE: collapse" borderColor="#6699ff" height="200" cellSpacing="0"
							...
							<tr>
								<td style="COLOR: #990000" align="center" background="../Images/bg_dh_middle.gif" bgColor="#ffffff"
									height="24" colspan="6"><font style="FONT-SIZE: 16px" face="黑体" color="#ffffff">修改试题</font></td>
							</tr>
							<TR>
										...
										<TABLE id="OperateTable" cellSpacing="1" cellPadding="1" width="100%" border="0">
											<TR id="trOperate" runat="server">
												<TD><INPUT class="text" id="TestFile" style="WIDTH: 264px; HEIGHT: 22px" type="file" size="24"
													...
													<asp:linkbutton id="lbtTestFile" runat="server" ToolTip="点击下载" Visible="False" onclick="lbtTestFile_Click">lbtTestFile</asp:linkbutton>
													<asp:linkbutton id="lbtDeleFile" runat="server" ToolTip="删除附件" Visible="False" onclick="lbtDeleFile_Click">删除</asp:linkbutton></TD>
											</TR>
										</TABLE>
									</asp:panel></td>
							</TR>
							<TR>
								...
								<td style="WORD-BREAK: break-all; HEIGHT: 23px" width="586" colSpan="5">
