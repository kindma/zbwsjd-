...
menu_chars+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='Images/chars6.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='InsertChars(5)'>省略号</a></td></tr>";
menu_chars+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='Images/chars7.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='InsertChars(6)'>破折号</a></td></tr>";
menu_chars+="<tr onmouseout='scolor(this)' onmouseover='rcolor(this)'><td><img src='Images/chars8.gif' width='16' height='16' align='absmiddle'></td><td><a href='#' onclick='InsertChars(7)'>中划线</a></td></tr>";
menu_chars+="</table>";
						...
						<tr>
							<td height="82">
								<div class="yToolbar" style="WIDTH: 100%">
									...
									<div class="TBSep"></div>
									<div class="Btn" TITLE="查找" LANGUAGE="javascript" onclick="findstr()">
						...
						<tr>
							<td height="82">
								<div class="yToolbar" style="WIDTH: 100%">
									...
									<div class="Btn" TITLE="插入特殊水平线" LANGUAGE="javascript" onclick="hr()">
										<img class="Ico" src="Images/sline.gif" WIDTH="20" HEIGHT="20">
									</div>
									<div class="Btn" TITLE="插入手动分页符" LANGUAGE="javascript" onclick="page()"><img class="Ico" src="Images/page.gif" WIDTH="18" HEIGHT="18">
									</div>
									<div class="Btn" TITLE="插入当前日期" LANGUAGE="javascript" onclick="nowdate()">
										<img class="Ico" src="Images/date.gif" WIDTH="20" HEIGHT="20">
									</div>
									<div class="Btn" TITLE="插入当前时间" LANGUAGE="javascript" onclick="nowtime()">
										<img class="Ico" src="Images/time.gif" WIDTH="20" HEIGHT="20">
									</div>
									<div class="Btn" TITLE="插入栏目框" LANGUAGE="javascript" onclick="FIELDSET()">
									...
									<div class="Btn" TITLE="表格菜单" LANGUAGE="javascript" onclick="ShowMenu(menu_table,100)">
										<img class="Ico" src="Images/table.gif" WIDTH="20" HEIGHT="20">
									</div>
									<div class="Btn" TITLE="符号菜单" LANGUAGE="javascript" onclick="ShowMenu(menu_chars,100)">
										<img class="Ico" src="Images/chars.gif" WIDTH="20" HEIGHT="20">
									</div>
									<div class="TBSep"></div>
									<div class="Btn" TITLE="插入图片，支持格式为：jpg、gif、bmp、png" LANGUAGE="javascript" onclick="pic()">
									...
									<div class="Btn" TITLE="插入音/视频文件，支持格式为：wav、mp3、mid、avi、wmv、mpg、asf" LANGUAGE="javascript" onclick="wmv()">
										<img class="Ico" src="Images/wmv.gif" WIDTH="20" HEIGHT="20">
									</div>
									<div class="Btn" TITLE="插入其它文件" LANGUAGE="javascript" onclick="otherfile()">
										<img class="Ico" src="Images/file.gif" WIDTH="20" HEIGHT="20">
									</div>
									<div class="TBSep"></div>
									<div class="Btn" TITLE="计算器" LANGUAGE="javascript" onclick="calculator()">
										<img class="Ico" src="Images/calculator.gif" WIDTH="18" HEIGHT="18">
									</div>
									<div class="TBSep"></div>
									<div class="Btn" TITLE="安装公式编辑器插件" LANGUAGE="javascript" onclick="InstallEQ()">
										<img class="Ico" src="Images/eq2.gif" WIDTH="18" HEIGHT="18">
									</div>
									<div class="Btn" TITLE="插入公式" LANGUAGE="javascript" onclick="InsertEQ()">
